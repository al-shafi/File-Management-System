...
<body>
	<header class="homeHeader">
				...
				<ul>
					...
					<?php
					 	...
					 	if (isset($_SESSION['restaurantid']) || isset($_COOKIE['restaurantcookie'])) {
							...
							echo "<li><a href='restaurant/order.php'>Orders</a></li>";
		...
		<form class="searchbox" action="" method="post">
			<input type="text" name="searchbox" placeholder="Search Restaurant">
			...
			if (isset($_POST['search']) && !empty($_POST['searchbox'])) {
				...
				if ($conn->query($query)) {
					...
					while ($row=$result->fetch_assoc()) {
						...
						$pic=$row['pic'];
						$address=$row['address'];
						echo "<a href='restaurant'><div class='restaurantLandingPage'><img src='restaurant/img/$pic'><p><br>$name</p></div></a>";
